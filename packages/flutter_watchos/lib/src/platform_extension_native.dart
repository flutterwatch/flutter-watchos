...
/// trivially inlinable. They are also Web-safe: on Web, where dart:io does not
/// exist, every getter is `false`.
///
/// ```dart
...
/// ```
///
/// This extension exists only where dart:io does — it is absent on Web, since
/// there is no `Platform` type there to extend. Cross-platform code that must
/// also build for Web should use the static [FlutterWatchosPlatform] getters,
/// which are available on every platform.
